# [Model-View-ViewModel (ie MVVM)](https://github.com/Ahmad Saifuddin/Android-MVVM-architecture)
...
You can also check [**MVP**](https://github.com/Ahmad Saifuddin/Android-MVP-Architecture)
